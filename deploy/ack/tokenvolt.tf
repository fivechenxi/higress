...
resource "alicloud_log_store_index" "tokenvolt" {
  ...
  # Access-log fields such as duration, upstream_host and
  # upstream_transport_failure_reason are written to the logstore but were not
  # indexed, so a failed request could not be traced back to the upstream host,
  # the transport reason or how long each attempt took.
  dynamic "field_search" {
    for_each = {
      ...
      "upstream_transport_failure_reason"    = "text"
      "ai_log.model"                         = "text"
      ...
      "ai_log.upstream_error_class"          = "text"
      "ai_log.upstream_error_type"           = "text"
      "ai_log.upstream_error_code"           = "text"
      "ai_log.upstream_error_message"        = "text"
      "ai_log.upstream_error_body"           = "text"
      "ai_log.upstream_error_body_truncated" = "text"
      "response_code"                        = "long"
      "response_flags"                       = "text"
      "duration"                             = "long"
      "bytes_received"                       = "long"
      ...
      "ai_log.reasoning_tokens"              = "long"
      "ai_log.chat_round"                    = "long"
