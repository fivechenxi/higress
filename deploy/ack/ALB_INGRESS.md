...
Enabling the OSS-managed ALB inputs authorizes the controller to create the separate pay-as-you-go ALB, EIPs, listeners, server group and forwarding rule. It does **not** authorize or perform a DNS change. Keep ALB creation and DNS cutover as separate reviewed phases:
